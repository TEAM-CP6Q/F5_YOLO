      ...
      >
        <View style={extendedStyles.modalContainer}>
          <View style={extendedStyles.modalContent}>
            <CameraView
              ref={cameraRef}
              style={extendedStyles.cameraView}
              onCameraReady={() => setHasPermission(true)}
            >
              <View style={extendedStyles.cameraControls}>
                <TouchableOpacity onPress={handleCapture} style={extendedStyles.captureButton}>
                  <Text style={extendedStyles.captureButtonText}>촬영</Text>
                </TouchableOpacity>
                <TouchableOpacity onPress={() => setCameraVisible(false)} style={extendedStyles.closeButton}>
